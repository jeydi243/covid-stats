    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context){
        return AlertDialog(
          ...
          title: Text('Covid19 Status v$kVersion',
            style: TextStyle(
  ...
  Future<void> _showupdate()async{
    return showDialog<void>(
        ...
        builder: (BuildContext context){
          return AlertDialog(
            backgroundColor: Colors.white,
            title: Text('Covid19 Status v${data['version']}',
              style: TextStyle(
                color: kBackgroundColor,
                fontFamily: 'SourceSansPro',
                fontWeight: FontWeight.bold,
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          CircleAvatar(
                            radius: 50.0,
                            backgroundImage: AssetImage('images/miza.png'),
                          ),
                          Padding(padding: EdgeInsets.only(top: 7.0),),
                          FadeAnimation(1,Text('Kadiongo Epa',
                            style: TextStyle(
                              fontSize: 25.0,
                              fontWeight: FontWeight.bold,
                              fontFamily: 'SourceSansPro',
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              FadeAnimation(1.3,IconButton(
                                ...
                                onPressed: (){
                                  customLaunch('https://github.com/jeydi243');
                                },
                              )),
                              SizedBox(
                                width: 10,
                              ...
                              FadeAnimation(1.5,IconButton(
                                ...
                                iconSize: kIconsize,
                                onPressed: (){
                                  customLaunch('http://www.facebook.com/jeydi243');
                                },
                              )),
                              SizedBox(
                                width: 10,
                              ...
                              FadeAnimation(1.6,IconButton(
                                ...
                                iconSize: kIconsize,
                                onPressed: (){
                                  customLaunch('http://www.linkedin.com/in/jeydi243');
                                },
                              )),
                            ],
                          ),
